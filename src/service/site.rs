...
use sea_orm::{ActiveModelTrait, ColumnTrait, Condition, EntityTrait, JoinType, NotSet, PaginatorTrait, QueryFilter, QueryOrder, QuerySelect, RelationTrait};
...
pub async fn detail(
    ...
    let site_vo = JyMainSite::Entity::find_by_id(id)
        ...
        .left_join(crate::entity::jy_main_store::Entity)
